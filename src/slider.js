$(document).ready(function () {
    $('.slider').slick({
        ...
        adaptiveHeight: false, //по-умолчанию выключена автоподстройка высоты слайда
        slidesToShow: 10, //кол-во слайдов, к-рые отображаются одновременно - 
 ...
 //автопромотка через период по-умолчанию выключена, если не бесконечно, то проматывает влево-вправо
        ...
        slidesPerRow: 2, //кол-во слайдов в ряду, по-умолчанию один
