$(document).ready(function () {
    $('.slider').slick({
        ...
        speed: 500,//скорость прокрутки по-умолчанию 300мс, чем больше, тем плавнее (медленнее)
 ...
 //автопромотка через период по-умолчанию выключена, если не бесконечно, то проматывает влево-вправо

        autoplay: true, //автопромотка через период по-умолчанию выключена, если не бесконечно, то проматывает влево-вправо
        ...
        variableWidth: false, //по-умолчанию выключено, если включена, 
        ...
        mobileFirst: false, // меняет привычислении брейкпоинтов значения макс-видз на мин-видз, 
